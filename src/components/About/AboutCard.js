      ...
      <Card.Body>
        <blockquote className="blockquote mb-0">
          <p style={{ textAlign: "justify" }}>
            ...
            <br /><br /> {}
            I'm currently working as an <span className="purple"> AI developer at The Institute of Fine Arts in New York City </span> where I am developing a state-of-the-art <span className="purple"> AI video translation system in Python and PyTorch, that accurately generates subtitles for live real-time events in 100+ languages with 
